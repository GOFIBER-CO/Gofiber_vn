                    ...
                    <div className='row justify-content-center'>
                        ...
                        <div className='col col-12 col-md-10 mt-4'>
                            ...
                            <p className='mt-2 extra'>
                                ...
                                Còn lại trong mọi trường hợp thông tin cá nhân thành viên sẽ được bảo mật trên máy chủ của vuoncuabe.vn.
                            </p>
                        </div>
                        ...
                        <div className='col col-12 col-md-10 mt-4'>
                            ...
                            <TextIconPrice content='Tên doanh nghiệp: HỘ KINH DOANH VƯỜN CỦA BÉ – ĐÀO TẤN' color='blue' />
                            <TextIconPrice content='Thành lập và hoạt động theo Giấy chứng nhận đăng ký doanh nghiệp số: 01A8025312 do Sở Kế hoạch và Đầu tư thành phố Hà Nội cấp ngày 23 tháng 09 năm 2019.' color='blue' />
                            <TextIconPrice content='Trụ sở chính: Số 15B Đào Tấn, phường Ngọc Khánh, quận Ba Đình, thành phố Hà Nội' color='blue' />
                        </div>
                        ...
                        <div className='col col-12 col-md-10 mt-4'>
                            ...
                            <TextIconPrice content='Gọi điện trực tiếp về số điện thoại: 0912277022' color='blue' />
                            <TextIconPrice content='Gửi mail: chief.vuoncuabe@gmail.com' color='blue' />
                        </div>
                        ...
                        <div className='col col-12 col-md-10 mt-4'>
                            ...
                            <p>
                                Tại vuoncuabe.vn, việc bảo vệ thông tin cá nhân của bạn là rất quan trọng,
                                bạn được đảm bảo rằng thông tin cung cấp cho chúng tôi sẽ được mật vuoncuabe.vn
                                cam kết không chia sẻ, bán hoặc cho thuê thông tin cá nhân của bạn cho bất kỳ người nào khác.
                                vuoncuabe.vncam kết chỉ sử dụng các thông tin của bạn vào các trường hợp sau:
                            </p>
                            ...
                            <p>
                                vuoncuabe.vn hiểu rằng quyền lợi của bạn trong việc
                                bảo vệ thông tin cá nhân cũng chính là trách nhiệm của chúng tôi nên trong bất kỳ trường hợp có thắc
                                mắc, góp ý nào liên quan đến chính sách bảo mật của vuoncuabe.vn, và liên quan đến việc thông tin cá
                                nhân bị sử dụng sai mục đích hoặc phạm vi đã thông báo vui lòng liên hệ qua số hotline 0912277022 hoặc email:
                                chief.vuoncuabe@gmail.com để xử lý và làm việc trực tiếp với khách hàng.
                            </p>
                        </div>
                    </div>
                </section>
