          ...
          <div className="section-content position-relative">
            ...
            <div className="row justify-content-center">
              ...
              <div className="col col-12 col-md-4 hide-for-medium">
                <div className="img">
                  <Image
                    src={require('@/public/images/firewall/anh-baovetoandien.png')}
                ...
                <div className="col-inner">
                  ...
                  <div className="text-center">
                    <p className="describe">
                      Giải đáp các thắc mắc thường gặp của khách hàng mới khi
                      lần đầu biết đến dịch vụ Hosting và Máy chủ hiệu năng cao
                      của GOFIBER
                    </p>
                  </div>
                </div>
