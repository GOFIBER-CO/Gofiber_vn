                                ...
                                <div className='row justify-content-center'>
                                    <div className='col col-12 col-md-10'>
                                        ...
                                        <div className='img text-center'>
                                            <Image src={require("@/public/images/introduction/Group36.png")} alt="Nền tảng website giá rẻ đầu tiên được thiết kế
                                    dành riêng cho người Việt" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='col col-12 col-lg-7'>
                                ...
                                <div className='row justify-content-center'>
                                    <div className='col col-12 col-md-10'>
                                        ...
                                        <div className='img text-center'>
                                            <Image src={require("@/public/images/introduction/Downfall-amico1.png")} alt="Chi phí thấp nhất cho một Website Đẹp/ Chuẩn / Tiện" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='col col-12 col-lg-7'>
                                ...
                                <div className='row justify-content-center'>
                                    <div className='col col-12 col-md-10'>
                                        ...
                                        <div className='img text-center'>
                                            <Image src={require("@/public/images/introduction/E-Wallet-bro1.png")} alt="Không cần / Không nhất thiết phải chi hàng trăm triệu
                                    cho nền tảng Website và ứng dụng ở thời điểm ban đầu" />
                                        </div>
                                    </div>
                                </div>
