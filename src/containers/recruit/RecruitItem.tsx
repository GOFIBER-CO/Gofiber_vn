  ...
  return (
    <div className={`${wrapperClassName}`}>
      <div className="recruit-item mt-4">
        <Link className="a" href={`/tuyen-dung/${item.slug}`}>
          <div className="img">
            <img
          ...
          <div className="recruit-info">
            ...
            <div className="mt-2 text-icon-info d-flex align-items-start">
              ...
              />
              <span>
                Hạn nộp hồ sơ: {moment(item?.expireDate).format("DD/MM/YYYY")}
              </span>
            </div>
            <div className="mt-2 text-icon-info d-flex align-items-start">
              <Image
              ...
              <span>
                ...
                <strong className="color_primary">
                  {formatNumber(item.fromSalary)} -{" "}
                  {formatNumber(item.toSalary)} VNĐ
                </strong>
              </span>
            </div>
