        ...
        <div className="row">
          <div className="wrapper_news">
            {/* <div className="d-flex justify-content-center">
              <div className="tabs">
                <button
                  onClick={() => setTab(NEWS_TAB.ALL)}
                  className={`tab_item tab_item__left ${
                    Boolean(tab === NEWS_TAB.ALL) ? "active" : ""
                  }`}
                >
                  Tất cả
                </button>
                <button
                  onClick={() => setTab(NEWS_TAB.NEWS)}
                  className={`tab_item ${
                    Boolean(tab === NEWS_TAB.NEWS) ? "active" : ""
                  }`}
                >
                  Tin tức
                </button>
                <button
                  onClick={() => setTab(NEWS_TAB.EVENT)}
                  className={`tab_item tab_item__right ${
                    Boolean(tab === NEWS_TAB.EVENT) ? "active" : ""
                  }`}
                >
                  Sự kiện
                </button>
