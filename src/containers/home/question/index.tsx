...
const dummyData = [
  ...
  },
  {
    id: "2",
    title:
      "Gofiber có hỗ trợ Domain Name Server (DNS) trong trường hợp tôi chưa có Hosting?",
    content: (
      <p>
        Trong trường hợp bạn chưa đăng ký dịch vụ Hosting, GoFiber sẽ hỗ trợ 1
        DNS dành cho Domain name mà bạn đã đăng ký để tránh trường hợp Domain
        name của bạn không được trỏ đến đâu cả. Vì vậy, trong trường hợp bạn cần
        sự hỗ trợ hãy liên hệ với chúng tôi để bạn có được những dịch vụ tốt
  ...
  },
  {
    ...
    content: (
      <p>
        Nếu tên miền của bạn đã được kích hoạt, sau 30 phút đồng hồ tính từ lúc
        bạn ký hợp đồng và thanh toán phí chúng tôi sẽ hoàn tất các thủ tục cho
        bạn.
      </p>
    ),
  },
    ...
    <section className="section-question">
      <div className="section-content position-relative">
        <Image
          ...
          alt="Torus1"
          className="img-torus img-torus__top"
        />
        <Image
          src={require("@/public/images/introduction/Torus2.png")}
          alt="Torus2"
