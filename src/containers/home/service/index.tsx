...
const data = [
    {
        ...
        content1: `Giao diện đẹp mắt, thân thiện với người dùng và công cụ tìm kiếm... là 
            ...
            Ngoài ra, các mẫu website do chúng tôi thiết kế cũng luôn được đảm bảo sự hiển thị đồng bộ và đẹp mắt trên các thiết bị khác nhau.`,
        content2: `
...
function ServiceList() {
    return (
        <div className='service_list'>
            {
                data.map(item => <ServiceItem key={item.id} item={item} />)
            }
        </div>
    )
}
