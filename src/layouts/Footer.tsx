                    ...
                    <div className='row'>
                        <div className='col-12 col-md-4'>
                            ...
                            <p className='font_size_14 font_weight_500 mt-3'>
                                Tự hào là một trong những đơn vị dịch vụ thiết kế website giá rẻ uy tín tại Việt Nam, chúng tôi tự tin đáp ứng mọi yêu cầu của quý khách,
                        ...
                        <div className='col-12 col-md-4'>
                            <div className='font_size_16 font_weight_500 color_primary'>Thông tin liên hệ</div>
                            <div className='mt-3'>
                                {
                                    infoData.map(item => (
                        ...
                        <div className='col-12 col-md-4'>
                            <div className='font_size_16 font_weight_500 color_primary mb-3'>Dịch vụ</div>
                            <div className='mt-3'>
                                {
                    ...
                    <div className='row'>
                        <div className='col col-12 col-md-4'>
                            <div className='hide-for-medium'>
                                <div className='d-flex align-items-center'>
                                    {
                                        socialData.map(item => <a key={item.id} href={item.link} className='button_social button_social__large'>
                                            <Image src={item.icon} alt={item.id} />
                                        </a>)
                                    }
                                </div>
                        ...
                        <div className='col col-12 col-md-4'>
                            <div className='d-flex align-items-center justify-content-center'>
                                {
                                    bankData.map(item => <div className='mx-2' key={item.id}>
                                        <Image src={item.image} alt={item.id} />
                                    </div>)
                                }
                            </div>
                            <div className='font_weight_500 text-center mt-2'>Copyright ©Gofiber.vn</div>
                        </div>
                    </div>
                </div>
            </section>
